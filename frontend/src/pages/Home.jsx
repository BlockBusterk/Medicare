            ...
            <div className='py-[30px] px-5'>
              <div className='flex items-center justify-center'> 
                ...
                <div className='mt-[30px]'>
                    ...
                    <p className='text-[17px] leading-7 text-textColor font-[400] mt-4 text-center'>
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
             ...
             <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text_para">3. Viewing our physicians who are accepting new patients, use 
                the online scheduling tool to select an appointment time. </li>
              </ul>
